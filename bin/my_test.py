...
import tqdm
# 论文中用的otb/vot2018/uav123评估的
config='/PATH/TO/YOUR/CONFIG_FILE'         #SiamRPN   -AlexNet   180fps # _depth_FIA
snapshot='/PATH/TO/YOUR/CHECKPOINTS'
tracker_name='' # YOUR TRACKER_NAME
        ...
        #for v_idx, video in tqdm(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == frame_counter:
                    ...
                    outputs = tracker.track(img,video.name,'VOT2018',idx+1)
